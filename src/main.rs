...
impl Solver {
    ...
    fn f_good_edges(&mut self, base_set: &HashSet<usize>, base: &HashSet<usize>, geta: f64) -> HashSet<usize> {
    ...
    fn uniform_sample(&mut self, S: &HashSet<usize>, error_bound: f64, delta: f64) {
        for &i in S {
            let e = &mut self.es[i];
    ...
    fn naive_i(&mut self, S: &HashSet<usize>, error_bound: f64, delta: f64) -> HashSet<usize> {
    ...
    fn pac_sampleprune(&mut self, S: &HashSet<usize>, error_bound: f64, delta: f64) -> HashSet<usize> {
        let p: f64 = 0.01;
    ...
    fn exact_expgap(&mut self, S: HashSet<usize>, error_bound: f64, delta: f64) -> HashSet<usize> {
        let mut r_elim = 1;
        let mut r_sele = 1;
        let mut s_cur = S;
